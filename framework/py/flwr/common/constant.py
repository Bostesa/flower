...
FLEETAPI_MQTT_PORT = "1883"
FLEETAPI_MQTT_TLS_PORT = "8883"
FLEET_API_MQTT_DEFAULT_ADDRESS = f"{SERVER_OCTET}:{FLEETAPI_MQTT_PORT}"
FLEET_API_MQTT_TLS_DEFAULT_ADDRESS = f"{SERVER_OCTET}:{FLEETAPI_MQTT_TLS_PORT}"
